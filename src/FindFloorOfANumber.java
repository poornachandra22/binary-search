public class FindFloorOfANumber{
    public static int findFloorOfANumber(int[] input_array, int value_to_be_found){
        int low_index = 0;
    ...
    public static void main(String[] args){
        ...
        System.out.println("\ntarget : " + target);
        int index_found = findFloorOfANumber(array, target);
        System.out.println("\nFloor Index :- " + index_found + " -> " + array[index_found]);
    }
}